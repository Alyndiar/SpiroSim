...
from math_backends import numba_backend, python_backend
...
register_backend(
    MathBackend(
        ...
        label="Python",
        available=True,
        generator=python_backend.generate_trochoid_points,
    )
)
register_backend(
    MathBackend(
        name="numba",
        label="Numba",
        available=numba_backend.NUMBA_AVAILABLE,
        generator=numba_backend.generate_trochoid_points,
    )
)
